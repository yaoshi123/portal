...
class TableUtils
{
    public static function getTable($data){
        ...
        $table->addCell(2300)->addText(iconv('utf-8', 'GB2312//IGNORE', '结构类别'),
            array('bold'=>true, 'size'=>12));
        $table->addCell(2300)->addText(iconv('utf-8', 'GB2312//IGNORE', $row->structure),
            array('size'=>12));
        ...
        $table->addCell(2300)->addText(iconv('utf-8', 'GB2312//IGNORE', '平面形式'),
            array('bold'=>true, 'size'=>12));
        $table->addCell(2300)->addText(iconv('utf-8', 'GB2312//IGNORE', $row->plane_form),
            array('size'=>12));
        ...
        $table->addCell(2300)->addText(iconv('utf-8', 'GB2312//IGNORE', '健康等级'),
            array('bold'=>true, 'size'=>12));
        $table->addCell(2300)->addText(iconv('utf-8', 'GB2312//IGNORE', $row->danger_level),
            array('size'=>12));
